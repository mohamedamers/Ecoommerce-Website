...
const Products = () => {
  ...
  const addProduct = (product) => {
    ...
    if (isLogged) {
      ...
      toast.success(t("added_success")); // ترجمة التنبيه
    } else {
      toast.error(t("login_error")); // ترجمة التنبيه
      setTimeout(() => {
        navigate("/login");
      }, 1500);
    }
              ...
              <div className="card text-center h-100 p-2">
                ...
                <div className="card-body d-flex flex-column">
                  <h5 className="card-title mb-3">
                    {/* تظبيط اسم المنتج عشان ميبقاش طويل ويبوظ الكارت */}
    ...
    <div className="container my-3 py-3">
      <div className="row">
        <div className="col-12">
          <h2 className="display-5 text-center fw-bold">{t("latest_products")}</h2>
          <hr />
        </div>
      </div>
